...
const MyChurchMember = () => {
	...
	const onSubmit = handleSubmit(async (value) => {
		const newURL = `${url}/api/member/register`;
		...
		<Container>
			<Wrapper>
				<Card onSubmit={onSubmit}>
					...
					<Title>
						<TitleHead>Member Register 🚀🥊</TitleHead>
						<TitleSub>
					...
					<Content>
						...
						<Span to="/signinMember">Sign in instead</Span>
					</Content>
